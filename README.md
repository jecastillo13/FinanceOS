...
- En modo local, las personas pueden usar **Crear una cuenta** desde la pantalla de acceso; cada una obtiene un espacio financiero independiente. Producción mantiene el autorregistro cerrado salvo que declares explícitamente `FINANCEOS_PUBLIC_SIGNUP=true`.
