...
export type SesionActiva = { id:number; dispositivo:string; creada_en:string; ultima_actividad:string; vence_en:string; actual:boolean };
...
export const financeApi = {
  ...
  sesiones: () => get<SesionActiva[]>("/auth/sesiones"),
  revocarSesion: (id:number) => remove(`/auth/sesiones/${id}`),
