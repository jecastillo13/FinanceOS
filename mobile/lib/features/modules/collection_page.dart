...
class _CollectionPageState extends State<CollectionPage> {
  ...
  Future<void> _delete(Map<String, dynamic> item) async {
    final confirmed = await showDialog<bool>(
        ...
        builder: (context) => AlertDialog(
              ...
              content: const Text(
                  'Esta acción puede afectar información relacionada. ¿Deseas continuar?'),
              actions: [
                TextButton(
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        floatingActionButton: widget.deleteResource == null
            ? null
                    ...
                    FinanceSurface(
                      ...
                      Container(
                          ...
                          decoration: BoxDecoration(
                              color:
                                  FinanceColors.primary.withValues(alpha: .2),
                              borderRadius: BorderRadius.circular(16)),
                          child: Icon(widget.icon, color: FinanceColors.cyan)),
                      ...
                      Expanded(
                          child: Column(
                            ...
                            Text('${items.length} registros sincronizados',
                                style:
                            ...
                            child: FinanceSurface(
                                ...
                                child: Row(children: [
                                  Container(
                                      ...
                                      height: 44,
                                      decoration: BoxDecoration(
                                          color: FinanceColors.surfaceHigh,
                                          borderRadius:
